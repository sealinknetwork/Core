...
namespace SealinkNetwork.Networks.Deployments
{
   /// <summary>
   /// BIP9 deployments for the Blockcore sample coin network.
   /// </summary>
   public class SealinkNetworkBIP9Deployments : BIP9DeploymentsArray
   {
      ...
      /// </summary>
      public SealinkNetworkBIP9Deployments() : base(NumberOfDeployments)
      {
      }
