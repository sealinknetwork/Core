...
namespace SealinkNetwork.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="SealinkNetworkMain"/> network block's header has a valid block version.
   /// </summary>
   public class SealinkNetworkHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
